...
switch ($modx->event->name) {
    ...
    case 'OnDocFormPrerender':
        ...
        if ($modx->getOption('use_editor') && $modx->getOption('which_editor') != 'Ace'){
...
if ($modx->event->name == 'OnDocFormPrerender' && (!$modx->getOption('use_editor') || $modx->getOption('which_editor') == 'Ace')) {
